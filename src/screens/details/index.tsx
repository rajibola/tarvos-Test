...
import {mask1} from '../../assets/images';
...
class Details extends React.Component {
  ...
  render() {
    const {name, price, amount} = this.state.data;
    return (
        ...
        <ScrollView>
          <View>
            <View style={styles.topView}>
              <Image source={mask1} style={styles.image} />
          ...
          <View style={styles.bottomView}>
            <Text style={styles.details}>
              100% Original Products {'\n'}This item is not returnable. Items
              like inner-wear, personal care, make-up, socks and certain
              accessories do not come under our return policy.
